...
latex_documents = [
    (master_doc, 'Snapm.tex', u'Snapm Documentation',
     u'Bryn M. Reeves', 'manual'),
]
...
man_pages = [
    (master_doc, 'snapm', u'Snapm Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Snapm', u'Snapm Documentation',
     author, 'Snapm', 'A snapshot manager for Linux systems.',
     'Miscellaneous'),
]
